...
$(function () {
    $.get("buss/SisteBestilling", function (buss) {
        ...
        ut += " <label>Avgang:  </label> " + buss.dag + ": kl " + buss.tidspunkt + "</br></br>" + " <label>Til:  </label> " + buss.reiserTil + "</br>" + " <label>Fra:  </label> " + buss.reiserFra + " <br><label > Pris:   </label > " + buss.pris + "</br > "
